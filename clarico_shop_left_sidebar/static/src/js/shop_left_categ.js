$(document).ready(function(){
	...
	if($('div').hasClass('oe_shop_left'))
		{
			...
			$("div").find("#no_product").css({"width":"75%","float":"right"});
	...
	if ($(window).width() < 900) {
		...
		$('#no_product').css("cssText","width : 100% !important;");
	}
...
$(document).ready(function() {
	$('.menu-filter').click(function(){
		$("#products_grid_before").addClass('left_products_grid_before');
	...
	$('.mobile-view-filter-close-btn').click(function(){
		$("#products_grid_before").removeClass('left_products_grid_before');
